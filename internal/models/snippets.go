...
// SnippetDto Define a Snippet type to hold the data for an individual snippet. Notice how
// the fields of the struct correspond to the fields in our MySQL snippets
// table?
...
func (m *SnippetModel) Insert(dto SnippetDto) (int, error) {
	...
	result, err := m.DB.Exec(stmt, dto.Title, dto.Content, dto.Expires)
	if err != nil {
		return 0, err
	}
